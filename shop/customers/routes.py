from flask import render_template,session, request,redirect,url_for,flash,current_app,make_response, Blueprint
from flask_login import login_required, current_user, logout_user, login_user
from shop import app,db,bcrypt,login_manager #,photos, search
...
#     return render_template('auth/customer/register.html', form=form)
...
#     return render_template('auth/customer/login.html', form=form)
...
# def forgot():
#     return render_template('auth/customer/forgot-password.html')


# @app.route('/reset-password')
# def resetpswd():
#     return render_template('auth/customer/reset-password.html')
