...
def reset_request():
    ...
    return render_template('auth/customer/reset_request.html', title='Reset Password', form=form)
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('users.login'))
    return render_template('auth/customer/reset_token.html', title='Reset Password', form=form)
